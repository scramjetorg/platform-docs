...
> 💡 **Note!** Please refer to methods and definitions described in [AppContext](/hub/types/AppContext) when writing a Sequence code.
...
- `cp -r node_modules/ package.json dist/` - it copies _node\_modules_ and _package.json_ to the _dist_ folder
