---
slug: "/framework/javascript"
title: "Framework JS pre-V5"
description: "Framework JS pre-V5"
separator: Advanced
position: 4
type: "framework"
order: 2
...
# Scramjet Framework Version pre-V5

[![npm package](https://badge.fury.io/js/@scramjet%2Fframework.svg)](https://badge.fury.io/js/@scramjet%2Fframework)
![Tests](https://github.com/scramjetorg/framework-js/actions/workflows/test.yml/badge.svg?branch=main)
[![Known Vulnerabilities](https://snyk.io/test/github/scramjetorg/framework-js/badge.svg)](https://snyk.io/test/github/scramjetorg/framework-js)
![License](https://img.shields.io/github/license/scramjetorg/framework-js?color=green&style=plastic)
![Version](https://img.shields.io/github/v/tag/scramjetorg/framework-js?label=version&color=blue&style=plastic)
[![Discord](https://img.shields.io/discord/925384545342201896?label=discord)](https://discord.gg/52USU8q7AX)
![GitHub stars](https://img.shields.io/github/stars/scramjetorg/framework-js?color=pink&style=plastic)
...
You can also use nightly build as npm dependency by referring to `nightly` branch (which is the latest build) from this repository: _package.json_
...
await stream3.reduce((prev, curr) => `${prev}-${curr}`, ""); // "foo-bar-baz"
```
...
DataStream.from([1, 2, 3, 4, 5, 6, 7, 8])
